...
5. 進行前端設計或 UI 調整時，參考 `.Codex/skills/frontend-design/SKILL.md`
...
**Codex 行為**：使用者要求進版時，直接用「目前 APP_VERSION + 1」當作新版本號，不需問也不需查 git history 比對。

## 架構規則
詳細規則已模組化至 `.Codex/rules/`：
